    ...
    <CaseStudiesWrapper>
      ...
      <section className="hero my-lg">
        <div className="container mt-xl">
          <h1 className="text-5xl">Centralizing Draw Management</h1>
        ...
        <div className="container wide my-xl">
          <img
          ...
          <div className="case-study-image-block my-xl">
            ...
            <div className="container">
              <p className="text-caption text-gray">
                ...
                different lines of business, each with their own set of features
                and workflows. This was a major pain point for lenders as they
                had to navigate between multiple experiences to get the
      ...
      <section className="section">
        <div className="container">
          ...
          <Grid templateColumns="1fr 1fr" gap="md">
            ...
            <GridBlock
              ...
              description={
                <>
                  <strong>"Draw Cards"</strong> provided at-a-glance context and
                  surfaced actions without leaving the page
                </>
              }
            />
            <GridBlock
        ...
        <div className="container wide darker">
          <Grid templateColumns="300px 1fr" gap="lg" className="my-2xl">
            <div>
              ...
              <p className="text-sm text-gray my-sm">
                ...
                <strong>Active</strong> and <strong>Historical</strong>. Active
                draws included draws across any status that was not
          ...
          <Grid templateColumns="1fr 1fr" gap="xl">
            <div className="case-study-image-block">
              <img
                src="/img-draw-desk-detail-panel.png"
                alt="Details panel"
              ...
              />
              <p className="text-caption text-gray">
                The draw card detail panel appears when a draw is selected. It
                contains the draw's details, actions, and context.
              </p>
            </div>
            <div className="case-study-image-block">
              <img
              ...
              />
              <p className="text-caption text-gray">
                The columns menu allows lenders to customize the columns that
                are displayed in the Draw Desk.
              </p>
            </div>
            <div className="case-study-image-block">
              <img
            ...
            <div className="case-study-image-block">
              ...
              />
              <p className="text-caption text-gray">
                The bulk actions panel allows lenders to perform bulk actions on
                the current selection of draws.
              </p>
            </div>
          </Grid>
        </div>
        ...
        <div className="container wide darker">
          <Grid templateColumns="300px 1fr" gap="lg" className="my-3xl">
            <div>
        ...
        <div className="container wide darker">
          <Grid templateColumns="300px 1fr" gap="lg" className="my-xl">
            <div>
        ...
        <div className="container">
          ...
          >
            <GridBlock
              ...
              description={
                <>
                  <strong>63% monthly usage rate</strong> - Draw Desk became the
                  top page in the application, demonstrating strong user
            ...
            <GridBlock
              ...
              description={
                <>
                  <strong>2.75 days average</strong> draw turnaround time across
                  all loan types, with Consumer loans at 2.9 days and
            ...
            <GridBlock
              ...
              description={
                <>
                  ...
                  multiple legacy pages, and improved developer velocity across
                  the platform
                </>
              }
            />
      ...
      <section className="section mt-2xl">
        <div className="container">
          ...
          <p className="text-base text-gray my-md">
            Introducing <strong>Saved Views</strong> was a pivotal moment—it set
            the stage for lender-driven customization, allowing them to tailor
            workflows while reducing the need for bespoke features. This balance
            of{" "}
            <strong>
              scalability, flexibility, and technical modernization
            </strong>{" "}
            positioned the product to serve lenders across all loan types more
            effectively. After the release of Draw Desk, saved views became the
            new standard for several of our grid experiences and became a key
            part of our product's design system.
          </p>
        </div>
      </section>
