...
export const metadata: Metadata = {
  title: "Writing | Matt Walkley",
  description:
    "Thoughts on product design, design systems, and building products that matter. Insights from a decade of design leadership.",
  keywords: [
    "design writing",
    "product design",
    "design systems",
  ...
  openGraph: {
    ...
    description:
      "Thoughts on product design, design systems, and building products that matter. Insights from a decade of design leadership.",
    type: "website",
    url: "https://mattwalkley.com/writing",
  },
  twitter: {
    card: "summary",
    title: "Writing | Matt Walkley",
...
const blogPosts = [
  {
    ...
    excerpt:
      "Lessons learned from creating and maintaining design systems for growing teams and products.",
  ...
  },
  {
    ...
    excerpt:
      "How artificial intelligence is reshaping the role of product designers and what skills we need to develop.",
    category: "AI & Design",
  ...
  },
  {
    ...
    excerpt:
      "Practical research methods I've used to uncover insights that drive product decisions.",
    category: "Research",
  ...
  },
  {
    ...
    excerpt:
      "How to establish design processes and culture when you're the first designer on the team.",
    category: "Leadership",
  ...
  },
  {
    ...
    excerpt:
      "How to give and receive feedback that improves design quality and team collaboration.",
    category: "Process",
  ...
  },
  {
    ...
    excerpt:
      "Quantitative and qualitative ways to measure the real impact of design decisions on business outcomes.",
    category: "Metrics",
        ...
        <div className="container">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-xl text-gray-600 leading-relaxed">
              Sharing insights on product design, design systems, and building
              products that people love. My thoughts on the industry, process,
        ...
        <div className="container">
          <div className="text-center max-w-2xl mx-auto">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Get notified when I publish new articles about product design,
              design systems, and industry insights.
            </p>
            <div className="flex gap-4 max-w-md mx-auto">
              ...
              />
              <button className="btn whitespace-nowrap">Subscribe</button>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="section bg-black text-white">
        <div className="container text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            ...
            can help bring your product vision to life.
          </p>
